...
art_movements = ["early-byzantine-c-330-750",
...
def download_movement(movement, titles_and_urls):
    ...
    printProgressBar(c, l, prefix = 'Progress:', suffix = 'images downloaded')
    ...
    for tup in titles_and_urls:
        ...
        if (tup[0] != "" and tup[1] != ""):
            ...
            # the filepath of a folder that has the name of the current movement
            newpath = os.path.join('X:\FILES\Programming\AutoML_Images', 'byzantine')
            ...
            printProgressBar(c + 1, l, prefix = 'Progress:', suffix = 'images downloaded')
            c += 1
    print()
    return
